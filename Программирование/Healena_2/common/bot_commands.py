...
private = {
    ...
    #BotCommand(command="inline_keyboard", description="Клавиатура"),
    ...
    #BotCommand(command="music", description="Музыку"),
    #BotCommand(command="mood", description="Мне интересно узнать как вы себя чувствуете сегодня"),
}