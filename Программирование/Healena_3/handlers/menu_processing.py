...
async def talk_menu(level, menu_name):
    image = InputMediaPhoto(media="https://vkusvill.ru/upload/resize/624924/624924_1200x600x70_c.webp", caption="В данный момент функция находится в разработке и временно недоступна. Спасибо за проявленный интерес, следите за обновлениями!")
